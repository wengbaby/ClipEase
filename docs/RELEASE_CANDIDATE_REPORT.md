...
轻贴 ClipEase 第二版已正式切到 `2.x` 版本线。此前 V2 开发和验收包曾沿用 `1.0.x` patch 线推进，现已按项目规则完成大版本开发 `+1` 收口：`2.0.0(260519.2258)` 为 V2 大版本切线包；当前收口包为 `2.3.21(260523.1408)`。
...
- 当前候选版本：`2.3.24`
- 当前构建号：`260523.1449`
- 当前 build/run：`2.3.24 (260523.1449)`
- 当前运行进程：PID `68093`
